...
class Poster:
    ...
    def __init__(self):
        ...
        self.tc_offset = datetime.now(pytz.timezone("America/Los_Angeles")).utcoffset()
    ...
    def draw(self, drawer, output):
        ...
        if self.drawer_type == "plain":
            height = height - 100
            self.colors["background"] = "#fdf6e3"
            self.colors["track"] = "#859900"
            self.colors["special"] = "#d33682"
